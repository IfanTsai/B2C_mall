"""
Django settings for B2C_mall project.
...
SECRET_KEY = 'b8h%l*b&&$a3)553a4-pf(=hqi71&6!+)p^4f9^573h4mp%#!o'
...
WSGI_APPLICATION = 'B2C_mall.wsgi.application'
...
# FastDFS客户端的配置文件路径，在utils/fdfs/storage.py中使用
